...
class OrdersEntity(pydantic.BaseModel):
    ...
    payment_session_id: typing.Optional[str]
    order_expiry_time: typing.Optional[str]
    order_note: typing.Optional[str]
    customer_details: typing.Optional[CustomerDetails]
    order_meta: typing.Optional[OrderMeta]
